...
export const studioContent: Record<Locale, StudioContent> = {
  zh: {
    ...
    intros: {
      work: '从品牌表达到产品体验，再到网站转化，我们用完整链路解决业务问题。',
      services: '以 UI/UX 为核心，搭配品牌策略与 Web 落地，适配 3-10 万预算段项目。',
      process: '轻咨询 + 重落地的 4 步流程，保证节奏、质量和商业结果同时在线。',
    },
    teamCards: [
      {
        name: 'Alex Chen',
    ...
    cases: [
      {
        ...
        scope: 'UI/UX · 教育',
        title: '教育产品体验改版',
        detail: '围绕“首日体验”重做引导与学习路径，降低认知负担并拉高激活。',
        metric: '试用转付费 +31%',
      ...
      },
      {
        ...
        title: '医疗 SaaS 工作台',
        detail: '搭建模块化工作台和设计系统，统一复杂业务场景下的操作体验。',
        metric: '关键任务时长 -28%',
      ...
      },
      {
        ...
        title: '消费品牌官网升级',
        detail: '完成双语品牌官网重构，兼顾视觉调性、叙事逻辑与线索转化。',
        metric: '有效咨询 +42%',
      ...
      },
      {
        ...
        scope: 'UI/UX · 金融科技',
        title: '财富管理平台升级',
        detail: '优化开户流程与资产看板，让复杂金融信息更易理解和决策。',
        metric: '开户完成率 +26%',
      ...
      },
      {
        ...
        scope: 'Web · B2B 制造业',
        title: '制造业客户门户改版',
        detail: '重构 B2B 门户信息架构与询盘链路，提升采购决策效率与商机质量。',
        metric: '高意向询盘 +35%',
      ...
      },
      {
        ...
        detail: '建立跨端设计系统与交互规范，提升多团队并行迭代效率。',
        metric: '设计交付周期 -30%',
  ...
  en: {
    ...
    intros: {
      work: 'From brand expression to product UX and conversion-ready websites, we solve growth problems across the full design chain.',
      services: 'UI/UX is our core offer, reinforced by brand strategy and web delivery for teams in the CNY 30k-100k range.',
      process: 'A lightweight-consulting, heavy-delivery workflow that keeps pace, quality, and business impact aligned.',
    },
    teamCards: [
      {
        name: 'Alex Chen',
    ...
    cases: [
      {
        ...
        detail: 'Redesigned first-day onboarding and lesson flow to improve activation and learning momentum.',
      ...
      },
      {
        ...
        detail: 'Built a modular dashboard and design system for complex multi-role operations.',
        metric: 'Task time -28%',
      ...
      },
      {
        ...
        detail: 'Rebuilt a bilingual brand site balancing visual identity, narrative, and conversion.',
      ...
      },
      {
        ...
        detail: 'Refined account opening and portfolio dashboard to simplify financial decisions.',
      ...
      },
      {
        ...
        detail: 'Restructured B2B portal IA and inquiry journey to improve lead quality and buyer efficiency.',
      ...
      },
      {
        ...
        detail: 'Built cross-platform components and interaction rules for faster multi-team release cycles.',
